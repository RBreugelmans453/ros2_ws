...
#ifndef WAVESHARE_REAL__WAVESHARE_SYSTEM_HPP_
#define WAVESHARE_REAL__WAVESHARE_SYSTEM_HPP_
...
#include "waveshare_real/wheel.hpp"
...
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(WaveShareHardware);

  WAVESHARE_REAL_PUBLIC
